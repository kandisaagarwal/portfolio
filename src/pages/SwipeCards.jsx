...
export default function SwipeCards({ i, title, description, img, url, progress, range, targetScale }) {
  ...
  return (
    ...
    >
<div
  className="relative w-[90vw] max-w-6xl h-[70vh] rounded-2xl overflow-hidden shadow-2xl border-1 border-white flex flex-col justify-center"
>
  ...
  <div className="relative grid grid-cols-1 md:grid-cols-2 h-full text-white">
    <div className="p-8 md:p-12 flex flex-col justify-center">
      <h2 className="text-3xl md:text-5xl font-semibold mb-4 leading-tight drop-shadow-[0_1px_0_rgba(0,0,0,0.6)]">
        {title}
      </h2>
